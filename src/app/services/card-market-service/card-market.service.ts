...
export class CardMarketService {
  constructor(private httpClient: HttpClient, public storeSearch:StoreSearch) {}
  ...
  private cardData = () => this.httpClient.get<StoreDto[]>(`${API_URL}/puntosDeVenta/?id=${getUserId()}`, {params: this.storeSearch.httpParams()})
}
